    ...
    <ScrollView>
      ...
      <View style={{ flexDirection: 'row', paddingTop: 20, paddingLeft: 20, paddingBottom: 10, justifyContent: 'space-between', alignItems: 'center' }}>
        <View style={{ flexDirection: 'row' }}>
          ...
          <Text style={{ fontSize: 18 }}> Chiến dịch đang tham gia</Text>
        </View>
        <Entypo name="chevron-small-right" size={30} color="black" style={{ marginRight: 10 }} />
      </View>
      <View
      ...
      <View style={{ flexDirection: 'row', paddingTop: 20, paddingLeft: 20, paddingBottom: 10, justifyContent: 'space-between', alignItems: 'center' }}>
        <View style={{ flexDirection: 'row' }}>
          ...
          <Text style={{ fontSize: 18 }}> Chiến dịch đã tham gia</Text>
        </View>
        <Entypo name="chevron-small-right" size={30} color="black" style={{ marginRight: 10 }} />
      </View>
      <View
      ...
      <View style={{ flexDirection: 'row', paddingTop: 20, paddingLeft: 20, paddingBottom: 10, justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Entypo name="add-to-list" size={24} color="black" />
          <Text style={{ fontSize: 18 }}> Hoạt động đang chờ kiểm duyệt</Text>
        </View>
        <Entypo name="chevron-small-right" size={30} color="black" style={{ marginRight: 10 }} />
      </View>
      <View
     ...
     <View style={{ flexDirection: 'row', paddingTop: 20, paddingLeft: 20, paddingBottom: 10, justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Octicons name="checklist" size={24} color="green" />
          <Text style={{ fontSize: 18, color: 'black' }}> Hoạt động đã đăng</Text>
        </View>
        <Entypo name="chevron-small-right" size={30} color="black" style={{ marginRight: 10 }} />
      </View>
      <View
